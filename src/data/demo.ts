...
export const orders: Order[] = [
  ...
  },
  {
    ...
    amc: "National Valuation Services",
    ...
    clientComments: [
      {
        id: "c2",
        author: "National Valuation Services",
  ...
  },
  {
    ...
    reportMetadata: legacyReport("Listing appraisal"),
  ...
  },
  {
    ...
    productType: "Small residential income property",
    ...
    propertyType: "2-4 unit residential income",
  ...
  },
  {
    ...
    client: "HarborPoint Lending",
    amc: "National Valuation Services",
    borrower: "Morgan Ellis",
    address: "1447 Ashford Creek Lane",
    city: "Kennesaw",
    state: "GA",
    zip: "30144",
    county: "Cobb",
  ...
  {
    id: "ord-demo-inspected",
    fileNumber: "CAA-26-1060",
    productType: "VA 1004",
    client: "First Carolina Community Bank",
    amc: "Direct Lender",
    borrower: "Miles Turner",
    address: "418 Meadow Fork Road",
    city: "Greenville",
    state: "SC",
    zip: "29609",
    county: "Greenville",
    appraiser: "Marcus King",
    reviewer: "Evan Brooks",
    orderedDate: "2026-07-08",
    dueDate: "2026-07-24",
    inspectionDate: "2026-07-19",
    inspection: inspection("2026-07-19", "2026-07-19T11:05:00-04:00"),
    reportMetadata: legacyReport("VA 1004"),
    status: "Inspected",
    priority: "High",
    fee: 700,
    clientFee: 700,
    ...
    payrollSnapshot: {
      ...
      techFee: 35,
      otherNonCommissionableFees: 0,
      commissionableBase: 665,
      defaultAppraiserSplit: 62,
      calculatedPayout: 412,
      finalPayout: 455,
      calculationSource: "Fixed order payout"
    },
    documents: 7,
    lastUpdate: "Inspection completed yesterday",
    nextAction: "Start report writing",
    loanType: "VA",
    occupancy: "Primary residence",
    propertyType: "Single family",
    contactName: "Miles Turner",
    contactPhone: "(864) 555-0184",
    accessInfo: "Inspection complete; photos uploaded.",
    assignmentPreference: "VA-qualified appraiser",
    lenderContact: "Iris Coleman",
    parcelNumber: "SC-23-1840-07",
    timeline: timeline("CAA-26-1060", "Marcus King"),
    notes: [],
    clientComments: [],
    documentsList: documents("CAA-26-1060", "Missing"),
    assignmentHistory: assignmentHistory("CAA-26-1060", "Marcus King"),
    revisionLog: [],
    auditTrail: auditTrail("CAA-26-1060"),
    reviewItems: []
  },
  {
    id: "ord-demo-ready",
    fileNumber: "CAA-26-1061",
    productType: "Desktop appraisal",
    client: "First Carolina Community Bank",
    amc: "Direct Lender",
    borrower: "Leah Simmons",
    address: "907 Willowbank Lane",
    city: "Charlotte",
    state: "NC",
    zip: "28211",
    county: "Mecklenburg",
    appraiser: "Talia Morris",
    reviewer: "Maya Chen",
    orderedDate: "2026-07-09",
    dueDate: "2026-07-22",
    reportMetadata: legacyReport("Desktop appraisal"),
    ...
    appraiserPayout: 300,
    documents: 8,
    lastUpdate: "Review approved",
    nextAction: "Deliver final report",
    loanType: "Portfolio",
    occupancy: "Investment",
    propertyType: "Condominium",
    contactName: "Leah Simmons",
    contactPhone: "(704) 555-0115",
    accessInfo: "Desktop scope; no inspection required.",
    assignmentPreference: "Desktop specialist",
    lenderContact: "Iris Coleman",
    parcelNumber: "NC-11-3904-21",
    timeline: timeline("CAA-26-1061", "Talia Morris"),
    notes: [],
    clientComments: [{ id: "c-demo-ready", author: "Iris Coleman", body: "Please release the PDF when approved.", visibility: "client", createdAt: "Jul 22, 9:10 AM" }],
    documentsList: documents("CAA-26-1061", "Ready"),
    assignmentHistory: assignmentHistory("CAA-26-1061", "Talia Morris"),
    revisionLog: [],
    auditTrail: auditTrail("CAA-26-1061"),
    reviewItems: [
      { label: "Report approved", category: "Review", complete: true },
      { label: "Delivery package ready", category: "Delivery", complete: true }
    ]
  },
  {
    id: "ord-demo-cancelled",
    fileNumber: "CAA-26-1062",
    productType: "Land appraisal",
    client: "Hollis Estate Representative",
    amc: "Direct Private Client",
    borrower: "Hollis Estate",
    address: "36 Red Clay Trail",
    city: "Columbia",
    state: "SC",
    zip: "29201",
    county: "Richland",
    ...
    appraiserPayout: 0,
    documents: 2,
    lastUpdate: "Cancelled by client",
    nextAction: "No action",
    loanType: "Private",
    occupancy: "Vacant",
    propertyType: "Land",
    contactName: "Grant Hollis",
    contactPhone: "(803) 555-0136",
    accessInfo: "Client cancelled before assignment.",
    assignmentPreference: "Rural land specialist",
    lenderContact: "Grant Hollis",
    parcelNumber: "SC-44-1290-01",
    timeline: timeline("CAA-26-1062", "Unassigned"),
    notes: [{ id: "n-demo-cancelled", author: "Mina Patel", body: "Client paused the estate settlement timeline.", visibility: "internal", createdAt: "Jul 12, 2:15 PM" }],
    clientComments: [{ id: "c-demo-cancelled", author: "Grant Hollis", body: "Please keep the order package available in case we restart.", visibility: "client", createdAt: "Jul 12, 2:22 PM" }],
    documentsList: documents("CAA-26-1062", "Missing"),
    assignmentHistory: [],
    revisionLog: [],
    auditTrail: auditTrail("CAA-26-1062"),
    reviewItems: []
  },
  {
    id: "ord-demo-attorney",
    fileNumber: "CAS-LEGAL-2601",
    productType: "Divorce appraisal",
    client: "Rowan Legal Group",
    amc: "Direct Private Client",
    borrower: "Rowan Legal Client",
    address: "208 Fern Hollow Court",
    city: "Raleigh",
    state: "NC",
    zip: "27608",
    county: "Wake",
    appraiser: "Talia Morris",
    reviewer: "Maya Chen",
    orderedDate: "2026-07-13",
    dueDate: "2026-07-30",
    inspectionDate: "2026-07-23",
    inspection: inspection("2026-07-23", "2026-07-23T15:30:00-04:00"),
    status: "Report In Progress",
    priority: "High",
    fee: 725,
    clientFee: 725,
    ...
    appraiserPayout: 520,
    documents: 6,
    lastUpdate: "Inspection completed",
    nextAction: "Prepare narrative support",
    loanType: "Private",
    occupancy: "Owner occupied",
    propertyType: "Single family",
    contactName: "Elise Rowan",
    contactPhone: "(919) 555-0188",
    accessInfo: "Attorney office coordinates access with both parties.",
    assignmentPreference: "Litigation/private-client specialist",
    lenderContact: "Elise Rowan",
    parcelNumber: "NC-92-6410-08",
    timeline: timeline("CAS-LEGAL-2601", "Talia Morris"),
    notes: [{ id: "n-demo-attorney", author: "Mina Patel", body: "Keep party-specific details internal and use client-safe updates only.", visibility: "internal", createdAt: "Jul 16, 1:25 PM" }],
    clientComments: [{ id: "c-demo-attorney", author: "Mina Patel", body: "The inspection is complete and the report is being prepared.", visibility: "client", createdAt: "Jul 23, 4:40 PM" }],
    documentsList: documents("CAS-LEGAL-2601", "Missing"),
    assignmentHistory: assignmentHistory("CAS-LEGAL-2601", "Talia Morris"),
    revisionLog: [],
    auditTrail: auditTrail("CAS-LEGAL-2601"),
    reviewItems: []
  },
  {
    id: "ord-demo-private",
    fileNumber: "CAS-PRIVATE-2601",
    productType: "Estate appraisal",
    client: "Elena Park",
    amc: "Direct Private Client",
    borrower: "Elena Park",
    address: "144 Rose Harbor Drive",
    city: "Charlotte",
    state: "NC",
    zip: "28210",
    county: "Mecklenburg",
    ...
    inspection: inspection("2026-07-24", "2026-07-24T14:15:00-04:00"),
    status: "Inspection Scheduled",
    priority: "Standard",
    fee: 550,
    clientFee: 550,
    ...
    nextAction: "Meet appraiser for inspection",
    loanType: "Private",
    occupancy: "Owner occupied",
    propertyType: "Single family",
    contactName: "Elena Park",
    contactPhone: "(704) 555-0173",
    accessInfo: "Owner will meet appraiser at the property.",
    assignmentPreference: "Residential estate specialist",
    lenderContact: "Elena Park",
    parcelNumber: "NC-33-7280-19",
    timeline: timeline("CAS-PRIVATE-2601", "Talia Morris"),
    notes: [{ id: "n-demo-private", author: "Mina Patel", body: "Private-client tracker should hide internal assignment and review notes.", visibility: "internal", createdAt: "Jul 14, 11:10 AM" }],
    clientComments: [{ id: "c-demo-private", author: "Mina Patel", body: "Your inspection is scheduled for July 24. We will send another update after the visit.", visibility: "client", createdAt: "Jul 21, 4:05 PM" }],
    documentsList: documents("CAS-PRIVATE-2601", "Missing"),
    assignmentHistory: assignmentHistory("CAS-PRIVATE-2601", "Talia Morris"),
    revisionLog: [],
    auditTrail: auditTrail("CAS-PRIVATE-2601"),
    reviewItems: []
  },
  {
    id: "ord-demo-fee",
    fileNumber: "NVS-26-8801",
    productType: "Conventional 1004",
    client: "HarborPoint Lending",
    amc: "National Valuation Services",
    borrower: "Camden Brooks",
    address: "612 Harbor Glen Way",
    city: "Savannah",
    state: "GA",
    zip: "31405",
    county: "Chatham",
    appraiser: "Renee Walker",
    reviewer: "Maya Chen",
    orderedDate: "2026-07-15",
    dueDate: "2026-07-26",
    reportMetadata: legacyReport("Conventional 1004"),
    status: "Accepted",
    priority: "High",
    fee: 600,
    clientFee: 600,
    ...
    payrollSnapshot: {
      ...
      techFee: 25,
      otherNonCommissionableFees: 0,
      commissionableBase: 575,
      fixedPayoutOverride: 500,
      calculatedPayout: 345,
      finalPayout: 500,
      calculationSource: "Fixed order payout",
      manualAdjustmentReason: "Public demo fee privacy example."
    },
    documents: 6,
    lastUpdate: "Vendor accepted assignment",
    nextAction: "Schedule inspection",
    loanType: "Pre-listing",
    occupancy: "Primary residence",
    propertyType: "Single family",
    contactName: "Camden Brooks",
    contactPhone: "(912) 555-0194",
    accessInfo: "Borrower prefers morning inspection windows.",
    assignmentPreference: "AMC panel vendor",
    lenderContact: "Claire Moon",
    parcelNumber: "GA-18-6901-03",
    timeline: timeline("NVS-26-8801", "Renee Walker"),
    notes: [{ id: "n-demo-fee", author: "Derek Sloan", body: "Use this file to demonstrate strict client/vendor/margin fee separation.", visibility: "internal", createdAt: "Jul 18, 9:45 AM" }],
    clientComments: [{ id: "c-demo-fee", author: "National Valuation Services", body: "The appraisal is assigned and moving toward inspection.", visibility: "client", createdAt: "Jul 18, 10:05 AM" }],
    documentsList: documents("NVS-26-8801", "Missing"),
    assignmentHistory: assignmentHistory("NVS-26-8801", "Renee Walker"),
    revisionLog: [],
    auditTrail: auditTrail("NVS-26-8801"),
    reviewItems: []
  }
];
...
export const notifications: NotificationItem[] = [
  ...
  },
  {
    ...
    detail: "National Valuation Services has 6 invoices over 30 days.",
    tone: "info",
    time: "12:10 PM"
  }
];
