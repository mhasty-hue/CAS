...
export const permissionCatalog: Array<{ key: PermissionKey; label: string; group: string }> = [
  ...
  { key: "view_client_fee", label: "View client fee", group: "Fee privacy" },
  { key: "edit_client_fee", label: "Edit client fee", group: "Fee privacy" },
  { key: "view_vendor_fee", label: "View vendor fee", group: "Fee privacy" },
  { key: "edit_vendor_fee", label: "Edit vendor fee", group: "Fee privacy" },
  { key: "view_margin", label: "View company margin", group: "Fee privacy" },
  { key: "view_accounting", label: "View accounting", group: "Fee privacy" },
  { key: "view_invoice", label: "View invoice", group: "Fee privacy" },
  { key: "manage_invoice", label: "Manage invoice", group: "Fee privacy" },
  { key: "view_commission", label: "View commission", group: "Fee privacy" },
  { key: "manage_commission", label: "Manage commission", group: "Fee privacy" },
  ...
  { key: "view_operational_dashboard", label: "View operational dashboard", group: "Dashboard" },
  { key: "view_payroll_summary", label: "View payroll summary", group: "Dashboard" },
  { key: "view_receivables_summary", label: "View receivables summary", group: "Dashboard" },
  { key: "view_profitability_summary", label: "View profitability summary", group: "Dashboard" },
  ...
  { key: "edit_inspections", label: "Edit inspections", group: "Orders" },
  { key: "reopen_orders", label: "Reopen orders", group: "Orders" },
...
const legacyReport = (reportType = "Legacy 1004 URAR") => ({
  reportStandard: "legacy_uad_2_6" as const,
  reportSchemaVersion: "UAD 2.6",
  reportType,
  assignmentType: "Residential mortgage lending",
  inspectionScope: "Interior and exterior" as const,
  propertyType: "Single family",
  submissionFormat: ["PDF", "MISMO XML"] as const,
  xmlVersion: "2.6",
  mismoVersion: "2.6 GSE",
  ucdpSubmissionStatus: "Ready" as const,
  ucdpFindings: ["Legacy UAD consistency checks pending."]
});

const uad36Report = {
  reportStandard: "uad_3_6" as const,
  reportSchemaVersion: "UAD 3.6",
  reportType: "Dynamic URAR",
  assignmentType: "Residential mortgage lending",
  inspectionScope: "Interior and exterior" as const,
  propertyType: "Single family",
  submissionFormat: ["PDF", "UAD 3.6 data package", "MISMO XML"] as const,
  xmlVersion: "3.6",
  mismoVersion: "MISMO 3.6",
  ucdpSubmissionStatus: "Not configured" as const,
  ucdpFindings: ["UAD 3.6 validation integration placeholder."]
};

const inspection = (date: string, completedAt?: string) => ({
  scheduledDate: date,
  scheduledStartTime: "10:00",
  scheduledEndTime: "11:00",
  timeZone: "America/New_York",
  completedAt,
  inspectionType: "Interior and exterior" as const,
  accessContact: "Borrower",
  accessNotes: "Confirm access contact 24 hours before arrival.",
  calendarSyncStatus: "Synced" as const,
  internalNote: "Inspection tracked through CAS demo calendar."
});
...
export const orders: Order[] = [
  {
    ...
    inspection: inspection("2026-06-27", "2026-06-27T10:54:00-04:00"),
    reportMetadata: legacyReport(),
    status: "In Review",
    organizationStatusId: "org-firm-1-status-qc-review",
    priority: "High",
    fee: 575,
    techFee: 25,
    otherNonCommissionableFees: 50,
    commissionSplitOverride: 50,
    appraiserPayout: 250,
    payrollSnapshot: {
      grossFee: 575,
      techFee: 25,
  ...
  },
  {
    ...
    inspection: inspection("2026-06-26", "2026-06-26T13:25:00-04:00"),
    reportMetadata: legacyReport("FHA 1004"),
    status: "Revisions Needed",
    priority: "Rush",
    fee: 650,
    techFee: 35,
    fixedAppraiserPayoutOverride: 125,
    appraiserPayout: 125,
    payrollSnapshot: {
      grossFee: 650,
      techFee: 35,
      ...
      manualAdjustmentReason: "Demo fixed payout override for revision-heavy FHA file."
    },
    documents: 11,
  ...
  },
  {
    ...
    inspection: inspection("2026-06-30"),
    reportMetadata: legacyReport("2055 Exterior"),
  ...
  },
  {
    ...
    dueDate: "2026-07-05",
    status: "Unassigned",
    organizationStatusId: "org-firm-1-status-searching-panel",
    priority: "Standard",
    fee: 550,
    techFee: 25,
    appraiserPayout: 330,
  ...
  },
  {
    ...
    inspection: { ...inspection("2026-07-01"), calendarSyncStatus: "Queued" },
    reportMetadata: uad36Report,
    status: "Accepted",
    priority: "Standard",
    fee: 560,
    techFee: 25,
  ...
  },
  {
    ...
    dueDate: "2026-07-03",
    inspectionDate: "2026-06-27",
    inspection: inspection("2026-06-27", "2026-06-27T12:10:00-04:00"),
    reportMetadata: uad36Report,
    status: "Submitted",
    priority: "High",
    fee: 925,
  ...
  },
  {
    ...
    dueDate: "2026-07-06",
    status: "New",
    organizationStatusId: "org-firm-1-status-waiting-engagement",
    priority: "Watch",
    fee: 540,
    techFee: 25,
    appraiserPayout: 324,
  ...
  },
  {
    ...
    reportMetadata: {
      ...
      reportSchemaVersion: "Private review",
      reportType: "Desktop review",
      assignmentType: "Portfolio review",
      inspectionScope: "Desktop/no physical inspection",
      propertyType: "Condo",
      submissionFormat: ["PDF"],
      ucdpSubmissionStatus: "Not configured",
      ucdpFindings: ["Non-lending review does not require UCDP submission."]
    },
    status: "Delivered",
    priority: "Standard",
    fee: 300,
  ...
  },
  {
    ...
    inspection: inspection("2026-06-15", "2026-06-15T09:40:00-04:00"),
    reportMetadata: legacyReport(),
    status: "Completed",
    priority: "Standard",
    fee: 565,
    ...
    payrollSnapshot: {
      ...
      techFee: 25,
      otherNonCommissionableFees: 0,
      commissionableBase: 540,
      defaultAppraiserSplit: 60,
      calculatedPayout: 324,
      finalPayout: 324,
