...
export const vendorCountyCoverage: VendorCountyCoverage[] = [
  ...
  {
    id: "cov-heritage-cobb-expired-license",
    displayName: "Heritage Residential Appraisals",
    managingOrganizationId: "org-amc-1",
    vendorProfileId: "ven-expired-license-demo",
    state: "GA",
    county: "Cobb",
    coverageType: "direct",
    productTypes: ["1004 URAR", "FHA 1004"],
    ...
    distanceMiles: 10.3,
    eligibilityStatus: "excluded",
    reason: "License is not current.",
    exclusionReasons: ["License is not current"]
  },
  {
    id: "cov-metro-desk-review-cobb",
    displayName: "Metro Desk Review Services",
    managingOrganizationId: "org-amc-1",
    vendorProfileId: "ven-unsupported-product-demo",
    state: "GA",
    county: "Cobb",
    coverageType: "direct",
    productTypes: ["Desktop Review", "Field Review"],
    specialties: ["Review"],
    complexPropertyCapable: false,
    ruralCapable: false,
    approvalStatus: "approved",
    ...
    distanceMiles: 7.9,
    eligibilityStatus: "excluded",
    reason: "Does not support this product type.",
    exclusionReasons: ["Does not support this product type"]
  },
  {
    id: "cov-cherokee-nearby-va",
    displayName: "Cherokee County Valuation",
    managingOrganizationId: "org-amc-1",
    vendorProfileId: "ven-nearby-demo",
    state: "GA",
    county: "Cherokee",
    coverageType: "direct",
    productTypes: ["VA 1004", "FHA 1004", "1004 URAR"],
    ...
    revisionRate: 4.5,
    distanceMiles: 18.4,
    eligibilityStatus: "nearby",
    reason: "Compliant nearby county coverage. Requires assignment-specific coverage confirmation for Pickens County.",
    exclusionReasons: []
  }
];
